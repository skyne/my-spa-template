                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      ...
                      <h4>
                        ...
                        <small><i class="fa fa-clock-o" /> 2 hours</small>
                      </h4>
                      <p>Why not buy a new awesome theme?</p>
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      ...
                      <h4>
                        Developers
                        <small><i class="fa fa-clock-o" /> Today</small>
                      </h4>
                      <p>Why not buy a new awesome theme?</p>
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      ...
                      <h4>
                        Sales Department
                        <small><i class="fa fa-clock-o" /> Yesterday</small>
                      </h4>
                      <p>Why not buy a new awesome theme?</p>
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      ...
                      <h4>
                        Reviewers
                        <small><i class="fa fa-clock-o" /> 2 days</small>
                      </h4>
                      <p>Why not buy a new awesome theme?</p>
                    </a>
                  </li>
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      <i class="fa fa-warning text-yellow" /> Very long description here that may not fit into the page and may cause design problems
                    </a>
                  </li>
                  <li>
                    <a href="#">
